...
function createSupabaseClient() {
  ...
  const SUPABASE_URL = import.meta.env['VITE_SUPABASE_URL'] || process.env['SUPABASE_URL'] || "https://lyllatooocxedhetwbbo.supabase.co";
  const SUPABASE_PUBLISHABLE_KEY = import.meta.env['VITE_SUPABASE_PUBLISHABLE_KEY'] || process.env['SUPABASE_PUBLISHABLE_KEY'] || "sb_publishable_W-2uBhUALzH0tq_79T3phg_9OdrqOcV";
