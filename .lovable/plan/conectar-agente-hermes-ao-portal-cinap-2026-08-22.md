...
- A chave de serviço (`SUPABASE_SERVICE_ROLE_KEY`) e a senha do banco devem permanecer somente no ambiente do servidor.
...
- O agente Hermes acessa a API pública autenticada por chave.
