...
import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-xGsVRDVx.js";
import { t as requireSupabaseAuth } from "./auth-middleware-UH_Jp6hR.js";
import { s as dataBR } from "./cinap-PoyC-pfo.js";
...
//#endregion
//#region src/lib/agent-keys.functions.ts
...
//#endregion
//#region src/routes/_authenticated/agentes.tsx?tsr-split=component
function Agentes() {
	const { isAdmin, carregando } = usePapel();
	const queryClient = useQueryClient();
	const [nome, setNome] = useState("");
	const [permissoes, setPermissoes] = useState(["read"]);
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", {
						...
						}) }), /* @__PURE__ */ jsxs("tbody", { children: [chaves.data?.map((chave) => /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("td", {
									...
									children: chave.permissoes.map((p) => /* @__PURE__ */ jsx("span", {
						...
						}, chave.id)), chaves.data?.length === 0 && /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", {
							colSpan: 6,
