...
import { n as hashChave, t as gerarChaveAgente } from "./agent-keys-oVnL2XVT.js";
...
//#endregion
//#region src/lib/agent-keys.functions.ts?tss-serverfn-split
...
var listarChavesAgente = createServerFn({ method: "GET" }).middleware([requireSupabaseAuth]).handler(listarChavesAgente_createServerFn_handler, async ({ context }) => {
	...
	const { supabaseAdmin } = await import("./client.server-DqzlzxEm.js").then((n) => n.t);
