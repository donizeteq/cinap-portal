...
import { a as brl, n as CATEGORIAS, o as categoriaClasses, r as MENSALIDADE_POR_CATEGORIA } from "./cinap-PoyC-pfo.js";
import { n as usePapel, t as PortalShell } from "./PortalShell-DW99jdga.js";
import { useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { useMutation, useQuery, useQueryClient } from "@tanstack/react-query";
import { toast } from "sonner";
//#region src/routes/_authenticated/congregacoes.tsx?tsr-split=component
var VAZIO = {
	nome: "",
	categoria: "Bronze",
	qdt_obreiros: 0,
					...
					children: /* @__PURE__ */ jsxs("table", {
						...
						children: [/* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", {
							...
							children: [
								...
								/* @__PURE__ */ jsx(Th, { children: "Localidade" }),
								/* @__PURE__ */ jsx(Th, { children: "Categoria" }),
								/* @__PURE__ */ jsx(Th, { children: "Obreiros" }),
								/* @__PURE__ */ jsx(Th, { children: "Mensalidade" }),
								/* @__PURE__ */ jsx(Th, { children: "Ações" })
							]
						}) }), /* @__PURE__ */ jsx("tbody", {
							className: "text-sm",
							children: (lista.data ?? []).map((c) => /* @__PURE__ */ jsxs("tr", {
								className: "transition-colors hover:bg-secondary/50",
								children: [
									/* @__PURE__ */ jsxs(Td, {
										className: "font-medium",
										children: [c.nome, !c.ativa && /* @__PURE__ */ jsx("span", {
									...
									/* @__PURE__ */ jsx(Td, { children: brl(Number(c.valor_mensalidade)) }),
						...
						children: [
							...
							/* @__PURE__ */ jsxs("label", {
								...
								children: [/* @__PURE__ */ jsx("span", {
									...
									children: CATEGORIAS.map((c) => /* @__PURE__ */ jsxs("option", {
										value: c,
										children: [
											c,
											" — ",
