...
Base: `https://id-preview--dc30c657-9a7a-40bd-9f53-f750ec4a7103.lovable.app/api/public/agent`
...
curl -H "X-Agent-Key: cinap-agent_sua-chave-aqui" \
     https://seu-dominio.lovable.app/api/public/agent/relatorio-mensal?referencia=06/2026
```
