...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DPdb2fcp.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BYmne7ua.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Va7XoWch.mjs"),
		import("./start-CGq_LYoP.mjs"),
